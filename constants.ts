...
// Categories whose third column counts UP toward the expected amount (money in),
// rather than DOWN from it (budget left). Keep in sync with AMOUNT_COLUMN_HEADERS.
export const GOAL_CATEGORIES: readonly CategoryName[] = ['Income', 'Savings', 'Investments'];

// Header for the third column of a category card's subcategory table.
export const AMOUNT_COLUMN_HEADERS: Record<CategoryName, string> = {
  Income:      'Received',
  Savings:     'Saved',
